...
class Seller(Base):
    ...
    marketplace_status: Mapped[str] = mapped_column(String(50), default='DRAFT', nullable=False, index=True)
...
class Branch(Base):
    ...
    is_marketplace_visible: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False, index=True)
    phone: Mapped[str | None] = mapped_column(String(50), nullable=True)
    email: Mapped[str | None] = mapped_column(String(255), nullable=True)
